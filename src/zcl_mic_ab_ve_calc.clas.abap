CLASS zcl_mic_ab_ve_calc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_mic_ab_ve_calc IMPLEMENTATION.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    data: lt_calc_data type standard table of zMIC_AB_travel_processor with DEFAULT KEY,
